...
---
# General Information
This data come from the study of Groenigen et al. 2014, https://doi.org/10.1126/science.1249534.
...
invisible(lapply(packages, library, character.only = TRUE)) #Loading
...
First, let's calculate the Response ratio for each experiment
...
Now, let's calculate the Response ratio for the various duration of time not grouped by experiment. The log response ratios will be grouped by less than 3 years, between 3 and 6 years including edge cases and then also more than six years.
...
soil_organic_carbon |>
  ...
  summarise(mean(log_response_ratio)) |> #Again group by, now for duration of experiment

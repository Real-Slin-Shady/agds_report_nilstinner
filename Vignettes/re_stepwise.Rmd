...
ggplot(data = ACI ,aes(y = fct_rev(rowname), x = R)) +
  ...
  ggplot(models$`PPFD_IN + LW_IN_F + VPD_F + TA_F + SW_IN_F + P_F + WS_F + CO2_F_MDS + PA_F`, aes(.fitted, .resid))+
    geom_point()+
  ...
  ggplot(models$`PPFD_IN + LW_IN_F + VPD_F + TA_F + SW_IN_F + P_F + WS_F + CO2_F_MDS + PA_F`,
         aes(.hat, .stdresid))+
